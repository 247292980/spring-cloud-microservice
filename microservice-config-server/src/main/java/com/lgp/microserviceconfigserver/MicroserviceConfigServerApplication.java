package com.lgp.microserviceconfigserver;
 ...
 * 说明：
 * 在application.yml中有个git.uri的配置，⽬前配置的是https://github.com/eacdy/spring-cloud-study/
 * 获取git上的资源信息遵循如下规则：
 ...
 *
 * 例如本例：可使⽤以下路径来访问microservice-config-client-dev.properties：
